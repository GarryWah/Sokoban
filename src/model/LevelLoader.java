        ...
        try {
            ...
            for (int i = 0; i < height; i++) {
                ...
                for (int j = 0; j < width; j++) {
                    switch (ar[j]) {
                        case 'X':
                            walls.add(new Wall(j * Model.FIELD_SELL_SIZE + x0, i * Model.FIELD_SELL_SIZE + y0));
                            break;
                        case '*':
                            boxes.add(new Box(j * Model.FIELD_SELL_SIZE + x0, i * Model.FIELD_SELL_SIZE + y0));
                            break;
                        case '.':
                        ...
                        case '&':
                            ...
                            break;
                        case '@':
                            player = new Player(j * Model.FIELD_SELL_SIZE + x0, i * Model.FIELD_SELL_SIZE + y0);
                            break;
                        case ' ':
                            break;
                    }
