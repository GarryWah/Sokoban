...
public class Model
{
    ...
    public boolean checkBoxCollision(Direction direction){
        ...
        if (go instanceof Box){
            Box x=(Box)go;
            if (checkWallCollision(x,direction)){return true;}
                ...
                switch (direction){
                    case UP:x.move(0,-FIELD_SELL_SIZE);break;
                    case DOWN:x.move(0,FIELD_SELL_SIZE);break;
                    case LEFT:x.move(-FIELD_SELL_SIZE,0);break;
                    case RIGHT:x.move(FIELD_SELL_SIZE,0);break;
                }
